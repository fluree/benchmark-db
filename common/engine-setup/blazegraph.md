...
../../common/run_benchmark.sh \
  ...
  -r 3 -w 1 -t 180 -o reports/<ds>/engines/blazegraph.tsv     # DBLP-core: 180 s; billion-scale: 300 s
```

Use `-t 180` (the DBLP spec) and `--post-form` (Blazegraph's `/sparql` was flaky with a
